    ...
    const leadership = [
        {
            ...
            message: "We aren't building another ed-tech giant. We are building a bridge. A bridge between the raw potential of Indian students and the practical demands of the global industry."
        },
        {
            name: "Priya Singh",
            role: "Chief Technology Officer",
            image: "https://api.dicebear.com/7.x/avataaars/svg?seed=Priya",
            message: "Technology changes every day, but our curriculum was stuck in the past. We decided to democratize access to 'real' engineering work through open-source intelligence."
        }
    ];
    ...
    const developers = [
        {
            ...
            message: "Crafting pixels into experiences. I wanted to build a platform that feels as premium as the skills we teach."
        },
        {
            ...
            message: "Scalability isn't just for servers, it's for careers. I built the engine that powers thousands of student journeys."
        },
        {
            ...
            message: "From a student to a builder. This platform gave me my first break, and now I'm helping build it for others."
        }
    ];
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div>
                            <p className="text-xl text-gray-400 leading-relaxed mb-6">
                                While India produces over <span className="text-white font-bold">1.5 million engineers</span> annually, reports suggest that less than <span className="text-white font-bold">20%</span> are employable for core software jobs.
                            </p>
                            <p className="text-gray-400 leading-relaxed">
                                Colleges focus on rote learning and outdated theories from the 90s. Meanwhile, the industry creates AI, Blockchain, and Cloud systems. This gap creates a paradox: <strong>Millions of jobless graduates, and thousands of unfilled tech jobs.</strong>
                            </p>
                        </div>
            ...
            <section className="py-20 bg-zinc-900 border-y border-zinc-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">We Are Not A Coaching Institute.</h2>
                        <p className="text-gray-400 max-w-2xl mx-auto text-lg">
                            We don't sell courses. We sell <span className="text-white font-bold">Discipline & Direction</span>.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="p-8 rounded-2xl bg-black border border-zinc-800 hover:border-blue-500/50 transition-colors">
                            ...
                            <p className="text-gray-400 text-sm leading-relaxed">
                                We curate the best free content from the internet. Why pay for knowledge that is already free? We structure it into a job-ready roadmap.
                            </p>
                        </div>
                        <div className="p-8 rounded-2xl bg-black border border-zinc-800 hover:border-purple-500/50 transition-colors">
                            ...
                            <p className="text-gray-400 text-sm leading-relaxed">
                                You don't learn swimming by reading a book. You learn coding by building projects. Our platform forces you to build, not just watch.
                            </p>
                        </div>
                        <div className="p-8 rounded-2xl bg-black border border-zinc-800 hover:border-green-500/50 transition-colors">
                            ...
                            <p className="text-gray-400 text-sm leading-relaxed">
                                We act as the bridge between your raw skills and the industry requirements. We verify your skills so recruiters can trust your resume.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                        <div>
                            ...
                            <div className="text-sm text-zinc-500 uppercase tracking-wider">Students Upskilled</div>
                        </div>
                        <div>
                            <div className="text-4xl md:text-5xl font-extrabold text-blue-500 mb-2">500+</div>
                            <div className="text-sm text-zinc-500 uppercase tracking-wider">Projects Deployed</div>
                        </div>
                        <div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        {leadership.map((leader, i) => (
                            <div key={i} className="flex flex-col md:flex-row gap-6 items-center md:items-start bg-black p-8 rounded-2xl border border-zinc-800">
                                <img src={leader.image} alt={leader.name} className="w-24 h-24 rounded-full border-4 border-zinc-800" />
            ...
            <section className="py-20 bg-black relative">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-400">Meet the engineering team that turned this vision into code.</p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {developers.map((dev, idx) => (
                            <div key={idx} className="bg-zinc-900/50 border border-zinc-800 p-6 rounded-2xl hover:-translate-y-2 transition-transform duration-300 group">
                                <div className="flex items-center gap-4 mb-6">
                                    <img src={dev.image} alt={dev.name} className="w-16 h-16 rounded-full border-2 border-zinc-700 group-hover:border-blue-500 transition-colors" />
                                    <div>
